function [results,R_squared]=Estimate_Granger_pairwise_NW(Y,Y_exclude,X_1,X_2,j, bw)
...
%            b(i,j)*r(j,t) + e(i,t+1),
%
% where test statistics are computed using a OLS with Newey West method
% Input
%
